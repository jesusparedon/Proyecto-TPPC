...
class mostrarAlumno(Frame):
    ...
    def ponerTodo(self):
        ...
        self.bolTxt = Label(self, text="Boleta: "+self.linea[3])
        self.bolTxt.grid(column=0, row=3, padx=8, pady=5)

        self.grupoTxt = Label(self, text="Grupo: "+self.linea[4])
        self.grupoTxt.grid(column=0, row=4, padx=8, pady=5)

        self.correoTxt = Label(self, text="Correo: "+self.linea[5])
